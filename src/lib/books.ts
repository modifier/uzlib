...
export const books: Books = {
	...
	'1988-poykend': {
		title: 'Городище Пайкенд. К проблеме изучения средневекового города Средней Азии',
		author: 'А. Р. Мухамеджанов, Ш. Т. Адылoв, Д. К. Мирзаахмедов, Г. Л. Семенов',
		year: 1988,
		size: '36 МБ'
	},
	'1989-masson-first-civilizations': {
